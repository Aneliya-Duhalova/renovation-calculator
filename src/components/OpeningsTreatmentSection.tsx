...
const OPTIONS: {
...
}[] = [
  {
    ...
    description:
      'Площта на прозорците/вратите се изважда от стените. За „Обръщане на врати и прозорци“ се ползват линейни метри (периметър на всеки отвор).',
  },
  {
    id: 'include_in_wall_area',
    title: 'Остават в квадратурата на стените',
    description:
      'Отворите не се изваждат – влизат в м² за шпакловка, боя и др. Обръщане на л.м. не се смята автоматично от отворите.',
  },
];
